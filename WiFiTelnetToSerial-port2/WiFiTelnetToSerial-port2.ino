...
const char* ssid = "totor";
const char* password = "271296160101230311";
...
//JJ  wifiMulti.addAP("ssid_from_AP_2", "your_password_for_AP_2");
//JJ  wifiMulti.addAP("ssid_from_AP_3", "your_password_for_AP_3");
